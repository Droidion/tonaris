...
function requireReactDomServer_bun_production() {
  ...
  var isomorphicReactPackageVersion$jscomp$inline_821 = React2.version;
...
function requireServer_bun() {
  ...
  var l;
  {
    b2 = requireReactDomServer_bun_production();
    l = requireReactDomServerLegacy_browser_production();
  }
  server_bun.version = b2.version;
  server_bun.renderToReadableStream = b2.renderToReadableStream;
  server_bun.resume = b2.resume;
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BbALyPff.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-DgXFWX8L.js").then((n2) => n2.k);
